        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('company.lawyers.update', $lawyer->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body pb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $lawyer->name) }}" class="form-control mb-3" required>
                                </div>

                                <div class="col-md-6">
                                    <label class="text-sm text-black">Phone Number</label>
                                    <input type="text" name="phone_number" value="{{ old('phone_number', $lawyer->phone_number) }}" class="form-control mb-3">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $lawyer->email) }}" class="form-control mb-3">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="address" value="{{ old('address', $lawyer->address) }}" class="form-control mb-3">
                                </div>
                            </div>
                                    ...
                                    <select name="jurisdiction_id" class="form-control mb-3" required>
                                        ...
                                        @foreach ($jurisdictions as $jurisdiction)
                                            <option value="{{ $jurisdiction->id }}"
                                                {{ old('jurisdiction_id', $lawyer->jurisdiction_id) == $jurisdiction->id ? 'selected' : '' }}>
                                                {{ $jurisdiction->title }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="additional_information" rows="4" class="form-control mb-3">{{ old('additional_information', $lawyer->additional_information) }}</textarea>
                                </div>
                            </div>
                        </div>
