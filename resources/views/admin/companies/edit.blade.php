                        ...
                        <div class="card-body pb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $company->user->name) }}"
                                        class="form-control mb-3" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Email</label>
                                    <input type="email" name="email" value="{{ old('email', $company->user->email) }}"
                                        class="form-control mb-3" required>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="company_subscription_plans_id" class="form-select text-black mb-3"
                                        ...
                                        <option value="{{ $plan->id }}"
                                            {{ old('company_subscription_plans_id', $company->company_subscription_plans_id) == $plan->id ? 'selected' : '' }}>
