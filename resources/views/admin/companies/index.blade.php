<x-app-layout>
    <x-navbar buttonName="Add Company" buttonUrl="{{ route('admin.companies.create') }}" />
                ...
                <div class="card mb-4">
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <div class="table-responsive" id="companyTableWrapper">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-sm mb-0 text-black">{{ $company->user->name }}</a>
                                            </td>
                                            <td>
