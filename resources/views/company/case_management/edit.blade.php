                        ...
                        <div class="card-body pb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="client_id" class="form-control mb-3" id="client-select" required>
                                        ...
                                        @foreach($clients as $client)
                                            <option value="{{ $client->id }}" data-email="{{ $client->email }}" data-address="{{ $client->address }}" {{ $caseManagement->client_id == $client->id ? 'selected' : '' }}>
                                                {{ $client->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="lawyer_id" class="form-control mb-3" id="lawyer-select" required>
                                        ...
                                        @foreach($lawyers as $lawyer)
                                            <option value="{{ $lawyer->id }}" data-email="{{ $lawyer->email }}" {{ $caseManagement->lawyer_id == $lawyer->id ? 'selected' : '' }}>
                                                {{ $lawyer->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="incarcerated" value="1" {{ $caseManagement->incarcerated ? 'checked' : '' }}>
                                        <label class="form-check-label">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="incarcerated" value="0" {{ !$caseManagement->incarcerated ? 'checked' : '' }}>
                                        <label class="form-check-label">No</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Case Number</label>
                                    <input type="text" name="case_number" class="form-control mb-3" value="{{ $caseManagement->case_number }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="date_of_arrest" class="form-control mb-3" value="{{ $caseManagement->date_of_arrest }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Date of Indictment</label>
                                    <input type="date" name="date_of_indictment" class="form-control mb-3" value="{{ $caseManagement->date_of_indictment }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="judge" class="form-control mb-3" value="{{ $caseManagement->judge }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="text-sm text-black">County</label>
                                    <input type="text" name="country" class="form-control mb-3" value="{{ $caseManagement->country }}">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select name="court_id" class="form-control mb-3">
                                        ...
                                        @foreach($courts as $court)
                                            <option value="{{ $court->id }}" {{ $caseManagement->court_id == $court->id ? 'selected' : '' }}>{{ $court->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <label class="text-sm text-black">Filing Date</label>
                                    <input type="date" name="filling_date" class="form-control mb-3" value="{{ $caseManagement->filling_date }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="calendar_clerk_name" class="form-control mb-3" value="{{ $caseManagement->calendar_clerk_name }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Email</label>
                                    <input type="email" name="calendar_clerk_email" class="form-control mb-3" value="{{ $caseManagement->calendar_clerk_email }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Name</label>
                                    <input type="text" name="opposing_counsel_name" class="form-control mb-3" value="{{ $caseManagement->opposing_counsel_name }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Email</label>
                                    <input type="email" name="opposing_counsel_email" class="form-control mb-3" value="{{ $caseManagement->opposing_counsel_email }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Name</label>
                                    <input type="text" name="clerk_of_court_name" class="form-control mb-3" value="{{ $caseManagement->clerk_of_court_name }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="text-sm text-black">Email</label>
                                    <input type="email" name="clerk_of_court_email" class="form-control mb-3" value="{{ $caseManagement->clerk_of_court_email }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="court_date_expected_time_to_resolve" class="form-control mb-3" value="{{ $caseManagement->court_date_expected_time_to_resolve }}">
                                </div>
                            </div>
                        </div>
