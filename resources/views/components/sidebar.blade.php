<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link flex-grow-1 d-flex align-items-center pe-0 me-0 mt-1 {{ request()->routeIs('company.calendar.index') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link flex-grow-1 d-flex align-items-center pe-0 me-0 mt-1 {{ request()->routeIs('company.conflict_logs.index') ? 'active' : '' }}""
                 href="{{ route('company.conflict_logs.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Conflict Logs</span>
                </a>
            </li>
